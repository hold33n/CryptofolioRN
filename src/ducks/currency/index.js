...
export const SELECT_CURRENCY: 'SELECT_CURRENCY' = 'SELECT_CURRENCY';

export const FETCH_CHART_REQUEST: 'FETCH_CHART_REQUEST' = 'FETCH_CHART_REQUEST';
export const FETCH_CHART_START: 'FETCH_CHART_START' = 'FETCH_CHART_START';
export const FETCH_CHART_SUCCESS: 'FETCH_CHART_SUCCESS' = 'FETCH_CHART_SUCCESS';
export const FETCH_CHART_FAIL: 'FETCH_CHART_FAIL' = 'FETCH_CHART_FAIL';

export const REFRESH_COIN_REQUEST: 'REFRESH_COIN_REQUEST' = 'REFRESH_COIN_REQUEST';
export const REFRESH_COIN_START: 'REFRESH_COIN_START' = 'REFRESH_COIN_START';
export const REFRESH_COIN_SUCCESS: 'REFRESH_COIN_SUCCESS' = 'REFRESH_COIN_SUCCESS';
export const REFRESH_COIN_FAIL: 'REFRESH_COIN_FAIL' = 'REFRESH_COIN_FAIL';
