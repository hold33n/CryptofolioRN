...
export const REFRESH_COIN_REQUEST: 'CURRENCY/REFRESH_COIN_REQUEST' =
  'CURRENCY/REFRESH_COIN_REQUEST';
export const REFRESH_COIN_START: 'CURRENCY/REFRESH_COIN_START' = 'CURRENCY/REFRESH_COIN_START';
export const REFRESH_COIN_SUCCESS: 'CURRENCY/REFRESH_COIN_SUCCESS' =
  'CURRENCY/REFRESH_COIN_SUCCESS';
...
export const fetchChartData = createAction(FETCH_CHART_REQUEST, (coinId, newFilter = 'All') => ({
  coinId,
  newFilter,
}));
export const refreshCoinData = createAction(REFRESH_COIN_REQUEST, (coinId, newFilter = 'All') => ({
  coinId,
  newFilter,
}));
...
function generateRef(coinId, filter) {
  ...
  return {
    method: 'post',
    url: `https://graphs2.coinmarketcap.com/currencies/${coinId}/${Date.now() -
