...
const HeaderTitleCurrencies = ({children, headerTitleVisibility}) => <Text
  style={[styles.headerTitleCurrencies, headerTitleVisibility && styles.headerTitleCurrenciesVisible]}>{children}</Text>;
